...
public class ConnDB {
	...
	private static String dbUrl = "jdbc:mysql://localhost:3306/bookmall?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";
	private static String dbUser = "root";	//登录SQL Server的用户名
	private static String dbPwd = "181805";	//登录SQL Server的密码
	/**
	 * 功能：创建与数据库的连接
	 * @return
	 */
