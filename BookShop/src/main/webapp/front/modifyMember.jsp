				...
				<div class="registration col-sm-6 col-sm-offset-3">
					...
					<form id="member-registration" action="modifyMember_deal.jsp"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="truename-lbl" for="truename" class="required">
											真实姓名 ：</label>
									</div>
									<div class="col-sm-8">
										<!-- 输入真实姓名的文本框 -->
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="pwd-lbl" for="pwd" class="required">
											原密码 ：</label>
									</div>
									<div class="col-sm-8">
										<!-- 密码文本框 -->
										<input type="password" name="pwd" id="pwd" value=""
												...
												maxlength="99" required="required" aria-required="true">
										<span class="star">&nbsp;*</span>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="newPwd-lbl" for="newPwd" class="required">
											新密码 ：</label>
									</div>
									<div class="col-sm-8">
										<!-- 密码文本框 -->
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="newPwd2-lbl" for="newPwd2" class="required">
											确认密码 ：</label>
									</div>
									<div class="col-sm-8">
										<!-- 确认密码文本框 -->
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="tel-lbl" for="tel" class="required">
											联系电话 ：</label>
									</div>
								...
								<div class="form-group">
									...
									id="email" value="<%=email%>" size="38"
									aria-required="true">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-offset-4 col-sm-8" style="margin-left: 150px;">
