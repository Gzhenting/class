...
<%
	...
	ResultSet rs = conn.executeQuery("select * from tb_book t1,tb_subType t2 where t1.typeID=t2.ID and t1.bookName like '%"
														...
														<div class="caption">
															<div class="name">
																<a href="bookDetail.jsp?ID=<%=ID%>" style="width: 95%">
																	<span style="color: #0885B1">书名：</span><%=bookName%></a>
															</div>
															<p class="price">
