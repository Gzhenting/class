		...
		<div class="container">
			<div class="row">
				<div class="toolbar-ct col-xs-12 col-md-6  hidden-sm hidden-xs">
					<div class="toolbar-ct-1">
						<img src="images/booklogo2.png" width="244px;" height="75px;">
					</div>
					<div>
						<!-- 搜索条 -->
				...
				<div class="toolbar-ct toolbar-ct-right col-xs-12 col-md-3">
					<div class="toolbar-ct-2 "
						...
						<a href="cart_see.jsp" style="color: #E33737; font-size: 20px;">
	...
	<div style="background-color: white; width: 100%">
		<div class="container">
			<div class="row">
				<div class="toolbar-ct col-xs-12 col-md-6  hidden-sm hidden-xs">
					<div class="toolbar-ct-1">
						<img src="images/booklogo2.png" width="244" height="75">
					</div>
					<div>
						<!-- 搜索条 -->
						<div class="search_box">
