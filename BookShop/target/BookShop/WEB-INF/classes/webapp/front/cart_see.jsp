...
<%@ page import="com.model.Bookelement"%><!-- 导入购物车图书的模型类 -->
								...
								<div class="table-responsive cart-info">
									<table class="table table-bordered">
										...
										<!-- 遍历购物车中的图书并显示 -->
											...
											<!-- 显示一条图书信息 -->
											<tr>
												<td class="text-center image" width="20%"><a href="bookDetail.jsp?ID=<%=bookitem.ID%>">
													<img width="80px" src="../images/book/<%=picture%>"> </a></td>
												<td class="text-left name"><a
													href="bookDetail.jsp?ID=<%=bookitem.ID%>"> <%=bookname%></a>
												</td>
