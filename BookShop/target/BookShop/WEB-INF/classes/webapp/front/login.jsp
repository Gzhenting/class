			...
			<div id="mr-content" class="mr-content col-xs-12">
				<div class="login-wrap" style="margin-bottom: 60px; margin-top: 50px">
					<div style="max-width: 540px; margin: 0 auto;">
						<a href="index.jsp" title="点击返回首页"><img src="images/booklogo2.png"></a>
					</div>
					<div class="login">
						...
						<form action="login_check.jsp" method="post" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="checkCode-lbl" for="checkCode" class="required">验证码 ：</label>
									</div>
								...
								<div class="form-group"
									...
									<label style="float: right; color: #858585; margin-right: 40px; margin-top: 10px; font-size: 14px;">没有账户？
										<a href="register.jsp">立即注册</a></label>
								</div>
							</fieldset>
						</form>
					</div>
