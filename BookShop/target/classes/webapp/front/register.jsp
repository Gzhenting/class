					...
					<div class="login">
						...
						<form id="member-registration" action="register_deal.jsp"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="pwd1-lbl" for="pwd1" class="required">
											密码 ：</label>
									</div>
									<div class="col-sm-8">
										<!-- 密码文本框 -->
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="pwd2-lbl" for="pwd2" class="required">
											确认密码 ：</label>
									</div>
									<div class="col-sm-8">
										<!-- 确认密码文本框 -->
								...
								<div class="form-group">
									<div style="float: right; padding-right: 216px;">
										BDS书铺<a href="agreement.jsp" target="_blank" style="color: #0885B1;">《使用条款》</a>
									</div>
								</div>
								<div class="form-group">
